...
'use strict';
/*
 * Guardià del COMPARADOR abans/després per partida (22/07/2026 · punt 2 correu la tècnica).
 *
 * Per què: el panell «Comparar abans/després» d'una lliçó pendent només mostrava els NOMS de les
 * partides que canvien, no el valor abans→després. la tècnica no podia entendre l'efecte de la regla.
