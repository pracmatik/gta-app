...
// 24/09/2026: _ocrLinies corregeix l'ortografia amb el vocabulari dels seus pressupostos (_ocrCorregeix): va amb ella
const _iLex = html.indexOf('const _OCR_LEX='), _fLex = html.indexOf('function _ocrLinies(', _iLex);
const srcLex = (_iLex >= 0 && _fLex > _iLex) ? html.slice(_iLex, _fLex).replace(/^const _OCR_LEX=/, 'var _OCR_LEX=') : '';
new vm.Script(srcLex + '\n' + srcNeteja + '\n' + srcLinies, { filename: 'ocr.js' }).runInContext(sb);
