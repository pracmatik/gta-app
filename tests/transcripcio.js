...
const NAMES = ['_dehyphen', '_stripPageArtifacts', '_cleanLit', '_RE_FI', '_RE_MARCA', '_UT_DOC', '_calibraMarca', '_scanMarques', '_iniciAmbTitol', '_titolAmbSalt', '_stripMeasureTail', '_locateRows', '_locateRowsCal', '_treuNumsSolts', 'repairDescsFromSource', 'recoverSkippedParts']; // 25/07: helpers nous del P4 (àncores autocalibrades + localitzador per assignació)
