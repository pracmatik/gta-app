 ...
 *     L'administració (21/07): «podeu tornar a deixar-ho com abans, sense la opció del desglòs que apareix ara?»
 *     La tècnica (21/07): «demanem sisplau treure aquesta nova funcionalitat per evitar errors.»
 *
 *     El defecte que van veure era real i era NOSTRE: el botó recollia a `kids` les línies de càlcul
 *     (que sumen) I les informatives (que no sumen), i les convertia TOTES a línia de càlcul. la tècnica:
...
// Obra-AD — la casella sortia buida i no es podien veure els números). Això no ho van qüestionar.
